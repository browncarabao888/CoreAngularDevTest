...
public partial class AppScaffoldedDbContext : DbContext
{
    public AppScaffoldedDbContext()
    {
    }

    public AppScaffoldedDbContext(DbContextOptions<AppScaffoldedDbContext> options)
        : base(options)
    {
    }
